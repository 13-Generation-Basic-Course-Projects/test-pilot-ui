...
import { ProjectResponseType, ProjectResponseTypes } from "@/types/project-type";
...
export const deleteProjectByIdService = async (projectId: string): Promise<void> => {
...
//Create project
export const createProjectService = async ({title , description}: NewProjectPayload) => {
  const newProject = {
    projectName: title,
