"use server";
import { createProjectService, deleteProjectByIdService, getAllProjectService, updateProjectByIdService } from "@/service/project-service";
import { ProjectItem } from "@/types";


//Delete rpoject
export const deleteProjectAction = async (projectId: string): Promise<ProjectItem[]> => {
...
export const createProjectAction = async(
  ...
  const response = await createProjectService({title : payload.projectName, description: payload.projectDescription});
