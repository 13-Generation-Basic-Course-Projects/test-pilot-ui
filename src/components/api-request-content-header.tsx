        ...
        <div className="w-full mx-auto mt-10 bg-white space-y-5">
            ...
            <Tabs defaultValue="authorization-type" className="w-full space-y-5">
                <TabsListV2 className="grid w-[400px] grid-cols-2">
                    <TabsTriggerV3 value="authorization-type">Authorization Type</TabsTriggerV3>
                    <TabsTriggerV3 value="manual">Manual</TabsTriggerV3>
                </TabsListV2>
                                    ...
                                    <TableCell>
                                        <AlertDialog>
                                            <AlertDialogTrigger asChild>
                                                <Trash2 className="text-[#E2001A] cursor-pointer" width={20} onClick={() => setDeleteIndex(index)} />
                                            </AlertDialogTrigger>
                                            <AlertDialogContent>
                                                <AlertDialogHeader>
