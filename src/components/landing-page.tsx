				...
				<div className="space-y-6 p-8">
					<div className=" items-center md:items-start gap-6">
						...
						<div className="max-w-md text-sm leading-relaxed text-gray-400 sm:text-left ">
							<p>
								<strong className="text-black">TestPilot</strong> is a modern
								platform built to simplify API testing and validation. With
								features like real-time monitoring, detailed validation reports,
								and a user-friendly interface, it helps developers test faster
