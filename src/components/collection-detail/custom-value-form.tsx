...
type CustomValueFormProps = {
  ...
  onEditCustomValue: (value: z.infer<typeof customValueSchema>, index: number) => void;
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>Enter your name case for test case</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>Enter your description for test case</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>Enter your value or regex for test case</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
