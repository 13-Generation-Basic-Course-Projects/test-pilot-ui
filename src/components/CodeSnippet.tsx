...
const CodeSnippet = () => {
    ...
    const selectedSnippet = codeSnippets.find(snippet => snippet.language === language);
            ...
            <div className=" border rounded-md w-[390px] p-2">
                <div className="flex items-center  justify-between  rounded-md focus:outline-none w-[100%] focus:ring-2 focus:ring-blue-100">
                    ...
                    <div className="relative">
                        ...
                        {copied && <span className="absolute top-[-20px] right-0 text-xs bg-gray-200 px-1 rounded">Copied!</span>}
                    </div>
