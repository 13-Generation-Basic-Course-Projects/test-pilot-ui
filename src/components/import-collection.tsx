      ...
      <DialogContent className="sm:max-w-2xl p-0 overflow-hidden rounded-lg">
        ...
        <div className="p-4 space-y-4">
          ...
          <Input
            ...
            className="w-full px-4 py-2 text-sm rounded border border-input"
          />

          {/* Drop Area */}
          <div
            className="border-2 border-dashed border-muted rounded-lg h-64 flex flex-col items-center justify-center text-center transition hover:bg-muted/20"
            onDrop={handleDrop}
